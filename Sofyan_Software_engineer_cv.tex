...
\subsection*{Back-end engineer @ Settle \hfill 2023/09 --- Present.} 
    \begin{zitemize}
        ...
        \item \textbf{Stack}: Python (Flask), JS (NodeJs), Postgresql, RabbitMQ, Docker, Microservices.
    \end{zitemize}
...
\subsection*{Back-end engineer @ Eden technologies \hfill 2022/12 --- 2023/09.} 
    \begin{zitemize}
        ...
        \item \textbf{Tech Stack:} Java (Spring Boot), JS (NodeJs), PostgreSQL, MongoDB, RabbitMQ.
    \end{zitemize}
...
\hskills{Programming Languages} & C++, Python/flask, Java/springboot, php/laravel, Js/nodejs. \\
